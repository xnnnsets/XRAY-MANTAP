...
# ==================================================
# Link Hosting Kalian
punyeorang="raw.githubusercontent.com/xnnnsets/XRAY-MANTAP/main/menu/xray"
...
curl https://${punyeorang}/nginx.conf > /etc/nginx/nginx.conf
curl https://${punyeorang}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${punyeorang}/index.html1"
