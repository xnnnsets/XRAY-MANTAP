...
shadowsockslink="ss://${shadowsocks_base64e}@isi_bug_disini:$tls?path=xrayssws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
shadowsockslink1="ss://${shadowsocks_base64e}@isi_bug_disini:$ntls?path=xrayssws&security=none&host=${domain}&type=ws#${user}"
