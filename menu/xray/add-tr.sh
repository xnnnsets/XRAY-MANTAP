...
trojanlink="trojan://${uuid}@isi_bug_disini:${tls}?path=%2Fxraytrojanws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
trojanlink2="trojan://${uuid}@isi_bug_disini:${ntls}?path=%2Fxraytrojanws&security=none&host=${domain}&type=ws#${user}"
...
echo -e "Path           : /xraytrojanws" | tee -a /etc/log-create-trojan.log
